...
const TableForms = ({ data, handleDelete, handleUpdate }) => {
  ...
  const startEdit = (item) => {
    setEditId(item._id);
    setFormValues({ title: item.title, type: item.type });
  };
  ...
  // Handle save action
  const handleSave = (id) => {
    handleUpdate(id, formValues); // Call parent function to save changes
        ...
        <table className="w-full table-auto">
          <thead>
            <tr className="bg-gray-2 text-left dark:bg-meta-4">
              ...
              <th className="min-w-[10px] text-center py-4 px-4 font-medium text-black dark:text-white">
                Action
              </th>
            </tr>
          </thead>
