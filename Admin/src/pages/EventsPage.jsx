  ...
  return (
    <DefaultLayout>
      ...
      <form onSubmit={handleAdd}>
        ...
        <div className="mt-4">
        <label htmlFor="eventLogo" className="mb-3 block text-black dark:text-white">Change event Image
        </label>
      <input
        id="eventLogo"
        type="file"
      ...
      />
        ...
        <div className="mt-4">
        {data&&data.name&& (<><label className="mb-3 block text-black dark:text-white">
