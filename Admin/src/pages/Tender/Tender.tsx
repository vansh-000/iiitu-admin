      ...
      <form onSubmit={handleSubmit}>
        <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <div className="flex flex-col gap-5.5 p-6.5">
            <div>
              <label htmlFor="description" className="mb-3 block text-black dark:text-white">Description of Tender</label>
              <input
                id="description"
                type="text"
            ...
            <div>
              <label htmlFor="annexure" className="mb-3 block text-black dark:text-white">Attach Annexure</label>
              <input
                id="annexure"
                required="required"
                ref={refAnnexure}
