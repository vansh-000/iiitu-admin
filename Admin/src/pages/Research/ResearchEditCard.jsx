    ...
    const handleSave = async () => {
      try {
        const data={
            ...
            universityLink: refUniversityLink.current?.value||editedData.universityLink,
            image: refUniversityImage.current?.files[0],
            file: refFile.current?.files[0]
        }
        const response=await axios.put(`${API}/research/${editedData._id}`, data, {
            headers: {
          ...
          {editable ? (
            <div className="relative">
              ...
              >
                ...
                <option value="Research" className="text-body dark:text-bodydark">
                  Research
                </option>
              </select>
