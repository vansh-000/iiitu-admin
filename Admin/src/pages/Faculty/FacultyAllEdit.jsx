...
const FacultyAllEdit = () => {
  ...
  const refPublication=React.useRef();
  ...
  const fetchFaculty = async () => {
    try {
      ...
      let publication='';
      for(let r=0;r<response.data.Publications.length;r++){
        if(r==0){
            publication+= `${response.data.Publications[r]}`;

        }
        else{
            publication += `\n#${response.data.Publications[r]}`;
        }
      }
          ...
          <div>
            ...
            <div className="relative">
              ...
              <textarea
                ...
                id="bio"
                rows={6}
                placeholder="Publication#Publication2#Publication3"
